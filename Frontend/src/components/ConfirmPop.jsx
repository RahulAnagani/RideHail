        ...
        <div className="flex flex-col w-full bg-white">
                    ...
                    <div className="w-full  h-[60%] bg-white">
                        ...
                        <div className="flex flex-col p-0">
                            ...
                            <FaWallet />
                                <div className="flex flex-col w-full border-b-2 pb-1">
                                    <h1 className="text-l font-semibold">562.54</h1>
                                    <p className="text-gray-400">Cash</p>
                                </div>
                            </div>
                            <div className="flex m-3 gap-2 justify-center flex-col items-center">
                                <button onClick={()=>{nav("/captain-riding")}} className="font-semibold text-white bg-green-400 p-2 w-[50%] active:bg-green-600 rounded">Confirm</button>
                                <button onClick={()=>{props.setConfirmRidePop(false);props.setRidePop(false)}} className="font-semibold text-white bg-red-600 p-2 w-[50%] active:bg-red-500 rounded">Reject</button>
                            </div>
