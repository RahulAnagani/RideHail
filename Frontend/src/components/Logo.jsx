const Logo=()=>{
    return (
        <svg
        className="w-20 z-10 absolute right-5" 
        width="64px"
        height="64px"
        viewBox="0 0 72 72"
      ...
      >
        ...
        <g stroke="#000" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
          <polyline fill="none" points="24.095 37.443 48.756 37.443 45.878 28.852" />
          <line x1="32" x2="41" y1="42.1606" y2="42.1606" />
          <line x1="32" x2="41" y1="44.7931" y2="44.7931" />
          <polyline fill="none" points="21 44.793 25 44.793 25 42.161" />
          <polyline fill="none" points="47 44.793 51 44.793 51 42.161" />
          ...
          <path fill="none" d="M26.3876,24.3126h0c0-2.3685,1.18-4.3064,2.6216-4.3064H42.9908c1.4419,0,2.6216,1.9379,2.6216,4.3064h0" />
          <path fill="none" d="M19.598,38.3373l2.0507-6.9637c1.1278-3.83,4.8183-6.9636,8.201-6.9636H36" />
          <path fill="none" d="M52.4019,38.3371l-2.0506-6.9635c-1.1279-3.83-4.8183-6.9636-8.201-6.9636H36" />
          <path fill="none" d="M36.2624,52.49H19.9134a2.9458,2.9458,0,0,1-2.9267-2.9474V42.5053c0-1.5965.89-4.0754,2.4927-4.0754" />
          <path fill="none" d="M35.6851,52.49h16.349a2.9458,2.9458,0,0,0,2.9267-2.9474V42.5053c0-1.5965-.89-4.0754-2.4927-4.0754" />
        </g>
      </svg>
    )
}
